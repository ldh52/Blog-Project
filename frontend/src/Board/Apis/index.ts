...
export const postBoardReqest = async(requestBody:PostBoardRequestDto,accessToken:string)=>{
...
export const patchNicknameReqest=async(reqestBody:PatchNicknameRequestDto,accessToken:string)=>{
    const result =await axios.patch(PATCH_NICKNAME_URL(),reqestBody,authorization(accessToken))
    .then(response=>{
...
export const patchProfileImageReqest=async(reqestBody:PatchProfileImageRequestDto,accessToken:string)=>{
    const result =await axios.patch(PATCH_PROFILE_IMAGE_URL(),reqestBody,authorization(accessToken))
    .then(response=>{
