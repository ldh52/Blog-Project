...
public class BoardController {
    ...
    public ResponseEntity<? super GetFavoriteListResponseDto> getFavoriteList(
        ...
        ResponseEntity<? super GetFavoriteListResponseDto> rresponse= boardService.getFavoriteList(boardNumber);
        return rresponse;
    }

    @GetMapping("/{boardNumber}/comment-list")
    public ResponseEntity<? super GetComentListResponseDto> getCommetList(
        @PathVariable("boardNumber")Integer boardNumber
        
    ){
        ResponseEntity<? super GetComentListResponseDto> response =boardService.getCommentList(boardNumber);
        return response;
    }
   
 //조회수 증가 effect가 2번 돌아서 만듬 
    ...
    public ResponseEntity<? super PatchBoardResponseDto> patchBoard(
        @RequestBody @Valid PatchBoardRquestDto requsetBody,
        @PathVariable("boardNumber") Integer boardNumber,
        @AuthenticationPrincipal String email
    ){
